...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        <title>Dimitri Christina Portfolio</title>
      ...
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between">
            <h1 className="text-xl font-burtons dark:text-white">developedbyjun</h1>
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-white">
              ...
              done remote work for Me~
              <span className="text-teal-500">agencies</span>
              consulted for
              <span className="text-teal-500">startups</span>
              and collaborated with talanted people to cretae digital for both
          ...
          <div className="lg:flex gap=10">
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white">
              <Image
                ...
                height={100}
              />
              <h3 className="text-lg font-medium pt-9 pb-2">
                Beautiful Designs
              </h3>
              <p className="py-2">
                Creating dlegant designs suited for your needs design theory.
              </p>
